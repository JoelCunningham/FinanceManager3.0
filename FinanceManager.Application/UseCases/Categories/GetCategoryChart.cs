...
{
    public async Task<GetCategoryChartResult> ExecuteAsync(IEnumerable<CategorySummary> categories, IEnumerable<ScopedPeriod> periods, ChartMode mode, bool isIncome)
    {
        ...
        foreach (var category in categories)
        {
            ...
            {
                var series = ChartSeries.LineDashedSeries(category.Name, category.Colour, budgetSeries, "Budget");
                serieses.AddRange(series.ToEChartsSeries());
            }
