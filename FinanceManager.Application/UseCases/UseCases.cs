...
)
{
    ...
    public Task<GetChart2DataResult> GetChart2DataAsync(IEnumerable<ScopedPeriod> range, Guid? drilldownGroupId, TransactionChartMode mode) => getChart2Data.ExecuteAsync(range, drilldownGroupId, mode);
